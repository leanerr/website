        ...
        return(<div style={{padding:0,margin:0}}>
            {/*nav*/}
                ...
                <div style={{height:'auto' ,paddingBottom:'5%'}}>
                    <Grid fluid>
                        <Row>
                            <Col sm={12} md={12} lg={12}> <div className="title paddiingTop">  <img className=" "  src={require('./../image/payment-successful@3x.png')} style={{height:'120px' , width : '120px'}}  alt=""/>
                                <div className="title " style={{paddingTop:'%'}}>
                                    <h5 className="font">پرداخت شما با موفقیت انجام گردید </h5>
