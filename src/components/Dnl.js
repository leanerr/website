            ...
            return(
               ...
               <div style={{display : 'flex' , textAlign:'center',  justifyContent: 'center' }}>
                   <div className="Dnl" style={{ paddingBottom:'20%'}}>
                       <a href="https://github.com/fitexapp/app/releases/download/latest/fitex.apk" className="hbtn hb-fill-middle-bg-br hbor4 hpill hpad2 " >  برای دانلود مستقیم کلیک کنید</a>
                       {/*<Grid fluit>*/}
                       {/*<Row>*/}
